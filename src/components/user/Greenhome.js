...
const Greenhome = () => {
    ...
    const fetchListings = async () => {
        try {
            const response = await axios.get('http://localhost:4000/Combine/allCombine?category=greenhome');
    ...
    useEffect(() => {
        console.log("Greenhome component rendered. Is logged in:", isLoggedIn);
